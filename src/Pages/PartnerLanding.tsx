...
export default function PartnerLanding (): JSX.Element {
    ...
    return (
        <div>
            ...
            <span className="block text-indigo-600 xl:inline">auto business</span>
            </h1>
            ...
            <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1559943098-9caf09cfeefd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80" alt="" />
            </div>
            </div>
